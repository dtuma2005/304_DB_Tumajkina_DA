...
* Кнопку "Оказанные услуги" для просмотра списка услуг, оказанных данным врачом, с указанием даты и стоимости. В этом списке также должны быть кнопки для выполнения операций CRUD.
